        ...
        <div className="bg-card rounded-2xl px-6 py-8 sm:px-10 sm:py-12 md:px-[66px] md:py-[62px]">
          <div className="mb-8 sm:mb-12 md:mb-[62px] text-center">
            ...
            <p className="text-xl sm:text-2xl md:text-[30px] text-muted-foreground leading-tight md:leading-[39px]">
              ...
              <span className="text-foreground font-semibold">adrian......@gmail.com</span>
            </p>
          </div>

          <div className="flex justify-center gap-3 sm:gap-4 md:gap-[30px] mb-8 md:mb-12">
            {otp.map((data, index) => (
              <input
                key={index}
                type="text"
                maxLength={1}
                className="w-16 h-16 sm:w-20 sm:h-20 md:w-[100px] md:h-[100px] text-2xl sm:text-3xl md:text-[36px] text-center rounded-lg md:rounded-[16px] border border-primary bg-input text-primary focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent font-medium"
                value={data}
